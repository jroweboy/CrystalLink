...
/** A connection for a {@link DiagTiledGraph}.
 *
 * @author davebaol */
public class DiagTiledConnection extends DefaultConnection<DiagTiledNode> {

	static final float NON_DIAGONAL_COST = (float)Math.sqrt(2);

	DiagTiledGraph worldMap;

	public DiagTiledConnection (DiagTiledGraph worldMap, DiagTiledNode fromNode, DiagTiledNode toNode) {
